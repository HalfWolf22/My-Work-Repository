...
def get_data():
    ...
    random_game_url = 'https://euw1.api.riotgames.com/lol/spectator/v4/featured-games?api_key=' + key
    ...
    for name in initial_summoner_names[:49]:
        ...
        summoner_url = 'https://euw1.api.riotgames.com/lol/summoner/v4/summoners/by-name/' + \
            name + '?api_key=' + key
    ...
    for accid in summoners[:, 2]:
        ...
        acc_url = 'https://euw1.api.riotgames.com/lol/match/v4/matchlists/by-account/' + \
            accid + '?api_key=' + key
